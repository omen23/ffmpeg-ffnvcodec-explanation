...
**This guide only aims at the cards compatible with the latest drivers – for cards using legacy drivers (390, 396, 410, 415) you need to checkout older branches from the videolan git**
